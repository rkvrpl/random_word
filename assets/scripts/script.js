...
const randomLetterOne = alphabet[indexOne];
const randomLetterTwo = alphabet[indexTwo];
const randomLetterThree = alphabet[indexThree];
const randomLetterFour = alphabet[indexFour];
const randomText = randomLetterOne + randomLetterTwo + randomLetterThree + randomLetterFour;
